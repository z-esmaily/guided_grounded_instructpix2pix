...
class SizePredictor:
    ...
    def predict_size(self, image, existing_bbox, existing_object_text, target_object_text, direction):
        ...
        # 5. گرفتن پیش‌بینی از تمام مدل‌ها و میانگین‌گیری
        all_preds = []
        ...
        # 6. محاسبه ابعاد و کادر نهایی (منطق شما)
